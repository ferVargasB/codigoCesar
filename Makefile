#############################################################################
# Makefile for building: codigoCesar.app/Contents/MacOS/codigoCesar
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  codigoCesar.pro
# Template: app
# Command: /Users/fernandovargas/Qt/5.7/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile codigoCesar.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = codigoCesar1.0.0
DISTDIR = /Users/fernandovargas/codigoCesar/.tmp/codigoCesar1.0.0
...
LIBS          = $(SUBLIBS) -F/Users/fernandovargas/Qt/5.7/clang_64/lib -framework QtWidgets -framework QtGui -framework QtCore -framework DiskArbitration -framework IOKit -framework OpenGL -framework AGL 
...
DIST          = ../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		...
		codigoCesar.pro aplicacion.h main.cpp \
		aplicacion.cpp
QMAKE_TARGET  = codigoCesar
DESTDIR       = 
TARGET        = codigoCesar.app/Contents/MacOS/codigoCesar
...
$(TARGET): ui_aplicacion.h $(OBJECTS)  
	@test -d codigoCesar.app/Contents/MacOS/ || mkdir -p codigoCesar.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: codigoCesar.pro ../Qt/5.7/clang_64/mkspecs/macx-clang/qmake.conf ../Qt/5.7/clang_64/mkspecs/features/spec_pre.prf \
		../Qt/5.7/clang_64/mkspecs/qdevice.pri \
		../Qt/5.7/clang_64/mkspecs/features/device_config.prf \
		../Qt/5.7/clang_64/mkspecs/common/unix.conf \
		../Qt/5.7/clang_64/mkspecs/common/mac.conf \
	...
	$(QMAKE) -spec macx-clang CONFIG+=debug CONFIG+=x86_64 CONFIG+=qml_debug -o Makefile codigoCesar.pro
...
codigoCesar.app/Contents/PkgInfo: 
	@test -d codigoCesar.app/Contents || mkdir -p codigoCesar.app/Contents
	@$(DEL_FILE) codigoCesar.app/Contents/PkgInfo
	@echo "APPL????" > codigoCesar.app/Contents/PkgInfo
codigoCesar.app/Contents/Resources/empty.lproj: 
	@test -d codigoCesar.app/Contents/Resources || mkdir -p codigoCesar.app/Contents/Resources
	@touch codigoCesar.app/Contents/Resources/empty.lproj
	
codigoCesar.app/Contents/Info.plist: 
	@test -d codigoCesar.app/Contents || mkdir -p codigoCesar.app/Contents
	@$(DEL_FILE) codigoCesar.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@BUNDLEIDENTIFIER@,Ninguno.codigoCesar,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,codigoCesar,g" -e "s,@LIBRARY@,codigoCesar,g" -e "s,@TYPEINFO@,????,g" ../Qt/5.7/clang_64/mkspecs/macx-clang/Info.plist.app >codigoCesar.app/Contents/Info.plist

all: Makefile \
		codigoCesar.app/Contents/PkgInfo \
		codigoCesar.app/Contents/Resources/empty.lproj \
		codigoCesar.app/Contents/Info.plist $(TARGET)
...
moc_aplicacion.cpp: ../Qt/5.7/clang_64/lib/QtWidgets.framework/Headers/QDialog \
	...
	/Users/fernandovargas/Qt/5.7/clang_64/bin/moc $(DEFINES) -D__APPLE__ -D__GNUC__=4 -D__APPLE_CC__ -I/Users/fernandovargas/Qt/5.7/clang_64/mkspecs/macx-clang -I/Users/fernandovargas/codigoCesar -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtWidgets.framework/Headers -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtGui.framework/Headers -I/Users/fernandovargas/Qt/5.7/clang_64/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include/c++/v1 -I/usr/local/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/8.0.0/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -I/usr/include -I'/System/Library/Frameworks (framework directory)' -I'/Library/Frameworks (framework directory)' -F/Users/fernandovargas/Qt/5.7/clang_64/lib aplicacion.h -o moc_aplicacion.cpp
